...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      name: 'featured',
      title: 'Feature on "Latest From Dancehall" Carousel? 🌟',
      type: 'boolean',
      description: 'Turn this ON to pin this article to the front of the "Latest From Dancehall" carousel on the homepage.',
      group: 'publishing',
      initialValue: false,
    }),
    defineField({
      name: 'featuredInCarousel',
      title: 'Show in Featured Articles Carousel? 🎠',
      type: 'boolean',
      description: 'Turn this ON to include this article in the Featured Articles carousel shown on the homepage. Only General section articles will appear there.',
      group: 'publishing',
      initialValue: false,
    }),
    defineField({
