...
const featuredStories = [
  {
    ...
    readTime: 8,
    featuredOrder: 1,
    trendingCategory: 'artist-spotlight',
    trendingScore: 95,
  ...
  },
  {
    ...
    readTime: 6,
    featuredOrder: 2,
    trendingCategory: 'industry-updates',
    trendingScore: 88,
    difficulty: 'beginner',
...
const trendingStories = [
  {
    ...
    readTime: 5,
    trendingScore: 98,
    trendingCategory: 'dance-challenges',
    body: [
      {
        _type: 'block',
        style: 'normal',
  ...
  },
  {
    ...
    readTime: 6,
    trendingScore: 92,
    trendingCategory: 'festival-news',
    body: [
      {
        _type: 'block',
        style: 'normal',
...
async function addOrganizedContent() {
  try {
    ...
    console.log('✅ All organized content added successfully!')
  } catch (error) {
