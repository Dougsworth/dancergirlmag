...
export default function FeaturedArticles() {
  ...
  useEffect(() => {
    const fetchArticles = async () => {
      try {
        setLoading(true);
        const data = await getArticles({ limit: 100, section: "general" });
        setArticles(data);
  ...
  return (
    <PageLayout>
      <motion.div
        ...
        animate="visible"
      >
        <motion.section className="py-16 md:py-24 relative overflow-hidden" variants={headerVariants}>
          <div className="container mx-auto px-4 relative z-10">
            ...
            <motion.div className="max-w-md mx-auto mb-8" variants={filterVariants}>
            ...
            {filteredArticles.length === 0 ? (
              ...
              >
                ...
                <h3 className="subsection-title mb-2">
                  {searchTerm ? 'No matching articles found' : 'No articles available yet'}
                </h3>
                <p className="text-muted-foreground max-w-md mx-auto">
                  {searchTerm ? 'Try adjusting your search terms.' : 'Check back soon for new featured articles!'}
                </p>
                {searchTerm && (
